...
let element3 = (
    <div id="A1-new2" style={styles}>
        A1-new2
        <div id="B1-new2" style={styles}>
            B1-new
            <div id="C1-new2" style={styles}>C1-new2</div>
            <div id="C2-new2" style={styles}>C2-new2</div>
        </div>
        <div id="B2-new2" style={styles}>B2-new2</div>
    </div>
);
    ...
    let element2 = (
        <div id="A1-new" style={styles}>
            ...
            <div id="B1-new" style={styles}>
                B1-new
                <div id="C1-new" style={styles}>C1-new</div>
                <div id="C2-new" style={styles}>C2-new</div>
            </div>
            <div id="B2-new" style={styles}>B2-new</div>
            <div id="B3" style={styles}>B3-new</div>
        </div>
    );
    ReactDOM.render(
        element2,
